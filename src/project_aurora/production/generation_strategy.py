...
GENERATION_MODE_ORIGINAL = "ORIGINAL"
...
def normalize_generation_mode(value: str) -> str:
    ...
    aliases = {
        ...
        "ORIGINALS": GENERATION_MODE_ORIGINAL,
        "ORIGINAL_STORYBOOK": GENERATION_MODE_ORIGINAL,
        "ORIGINAL_COLLECTION": GENERATION_MODE_ORIGINAL,
    }
...
def listing_family_for_generation_mode(generation_mode: str) -> str:
    ...
    if mode in {GENERATION_MODE_STORYBOOK, GENERATION_MODE_ORIGINAL}:
